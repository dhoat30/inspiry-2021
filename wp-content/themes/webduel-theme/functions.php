...
require get_theme_file_path('/inc/customer-service/feedback-form.php');
 ...
 function inspiry_scripts(){ 
   ...
   if (strstr($_SERVER['SERVER_NAME'], 'localhost')) {
      ...
      wp_enqueue_script('main', get_theme_file_uri('/bundled-assets/scripts.3a5f1833cd48a9b94dad.js'), NULL, '1.0', true);
      wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.3a5f1833cd48a9b94dad.css'));      
